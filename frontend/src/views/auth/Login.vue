<template>
  <div class="login-layout">
    ...
    <!-- Logo - Top Left -->
    <!-- 品牌改造：原为指向上游仓库的外链，已去掉外链只留图标。
         logo 图片走替换 assets/img/weknora.png 的方式，不改这里的路径，
         少一处与上游的冲突点。 -->
    <div class="header-logo">
      <img src="@/assets/img/weknora.png" alt="TeKnowra" class="logo-image" />
    </div>

    <!-- Header Links - Top Right -->
    <div class="header-links">
      <!-- 品牌改造：已移除上游官网与 GitHub 两个外链，只保留语言切换。 -->
