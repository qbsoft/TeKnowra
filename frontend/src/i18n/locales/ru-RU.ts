export default {
  ...
  agentEditor: {
    ...
    tools: {
      ...
      mcpNameDegraded: 'В имени сервиса нет пригодных ASCII-символов, поэтому его инструменты называются mcp__xxx и конфликтуют с другими такими сервисами; лишний молча отбрасывается. Переименуйте латиницей.',
